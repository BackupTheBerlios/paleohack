// (I have not touched this file. much.)
...
#define FIRST_CALLABLE 110 /* added this */
...
#define	Adornment	you.uprops[0].p_flags
#define	RIN_ADORNMENT	176
#define	Teleportation	you.uprops[1].p_flags
#define	RIN_TELEPORTATION	177
#define	Regeneration	you.uprops[2].p_flags
#define	RIN_REGENERATION	178
#define	Searching	you.uprops[3].p_flags
#define	RIN_SEARCHING	179
#define	See_invisible	you.uprops[4].p_flags
#define	RIN_SEE_INVISIBLE	180
#define	Stealth	you.uprops[5].p_flags
#define	RIN_STEALTH	181
#define	Levitation	you.uprops[6].p_flags
#define	RIN_LEVITATION	182
#define	Poison_resistance	you.uprops[7].p_flags
#define	RIN_POISON_RESISTANCE	183
#define	Aggravate_monster	you.uprops[8].p_flags
#define	RIN_AGGRAVATE_MONSTER	184
#define	Hunger	you.uprops[9].p_flags
#define	RIN_HUNGER	185
#define	Fire_resistance	you.uprops[10].p_flags
#define	RIN_FIRE_RESISTANCE	186
#define	Cold_resistance	you.uprops[11].p_flags
#define	RIN_COLD_RESISTANCE	187
#define	Protection_from_shape_changers	you.uprops[12].p_flags
#define	RIN_PROTECTION_FROM_SHAPE_CHANGERS	188
#define	Conflict	you.uprops[13].p_flags
#define	RIN_CONFLICT	189
#define	Gain_strength	you.uprops[14].p_flags
#define	RIN_GAIN_STRENGTH	190
#define	Increase_damage	you.uprops[15].p_flags
#define	RIN_INCREASE_DAMAGE	191
#define	Protection	you.uprops[16].p_flags
#define	RIN_PROTECTION	192
#define	Warning	you.uprops[17].p_flags
#define	RIN_WARNING	193
#define	Teleport_control	you.uprops[18].p_flags
#define	RIN_TELEPORT_CONTROL	194
#define LAST_CALLABLE 194 /* added this */
#define	DIAMOND	197
#define	RUBY	198
#define	SAPPHIRE	199
#define	EMERALD	200
...
#define MAX_GEMS (216 - DIAMOND) /* for setgemprobs */
...
// Oh, these were in hack.h:
/* perhaps these #define's should also be generated by makedefs */
#define TELEPAT         LAST_RING               /* not a ring */
#define Telepat         you.uprops[TELEPAT].p_flags
#define FAST            (LAST_RING+1)           /* not a ring */
#define Fast            you.uprops[FAST].p_flags
#define CONFUSION       (LAST_RING+2)           /* not a ring */
#define Confusion       you.uprops[CONFUSION].p_flags
#define INVIS           (LAST_RING+3)           /* not a ring */
#define Invis           you.uprops[INVIS].p_flags
#define Invisible       (Invis && !See_invisible)
#define GLIB            (LAST_RING+4)           /* not a ring */
#define Glib            you.uprops[GLIB].p_flags
#define PUNISHED        (LAST_RING+5)           /* not a ring */
#define Punished        you.uprops[PUNISHED].p_flags
#define SICK            (LAST_RING+6)           /* not a ring */
#define Sick            you.uprops[SICK].p_flags
#define BLIND           (LAST_RING+7)           /* not a ring */
#define Blind           you.uprops[BLIND].p_flags
#define WOUNDED_LEGS    (LAST_RING+8)           /* not a ring */
#define Wounded_legs    you.uprops[WOUNDED_LEGS].p_flags
#define STONED          (LAST_RING+9)           /* not a ring */
#define Stoned          you.uprops[STONED].p_flags
#define PROP(x) (x-RIN_ADORNMENT)       /* convert ring to index in uprops */

// these were in hack.h too:
